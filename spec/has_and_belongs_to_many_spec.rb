  ...
  context "with has_and_belongs_to_many" do
    ...
    context "with deleted" do
      it "not fetch deleted objects" do
        ...
        expect{ server.delete }.to change{ Server.count }.by(-1).and change{ Network.count }.by(0)
      ...
      it "not fetch deleted objects - from both directions" do
        ...
        expect{ network.delete }.to change{ Network.count }.by(-1).and change{ Server.count }.by(0)
